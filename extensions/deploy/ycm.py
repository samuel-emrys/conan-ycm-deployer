...
"""
    ...
    ycm_data = template.format(cxx_version=cxx_version)
    flags_data = json.dumps(conan_flags, indent=4)

    save(graph.root.conanfile, os.path.join(graph.root.conanfile.build_folder, "conan_ycm_extra_conf.py"), ycm_data)
    save(graph.root.conanfile, os.path.join(graph.root.conanfile.build_folder, "conan_ycm_flags.json"), flags_data)
    save(graph.root.conanfile, ".conan_ycm_path", graph.root.conanfile.build_folder)
